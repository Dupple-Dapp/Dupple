...
// Define enums to match the contract's Enums
const Enums = {
  RelationshipStatus: {
    Single: 0,
    InRelationship: 1,
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => updateFormData('gender', parseInt(e.target.value))}
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => updateFormData('interestedIn', parseInt(e.target.value))}
                  className="w-full rounded-lg border border-gray-300 py-2 px-3 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-purple-600"
                >
                  <option value={Enums.Gender.Male}>Men</option>
                  <option value={Enums.Gender.Female}>Women</option>
                  <option value={Enums.Gender.NonBinary}>Non-binary people</option>
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => updateFormData('relationshipStatus', parseInt(e.target.value))}
                  className="w-full rounded-lg border border-gray-300 py-2 px-3 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-purple-600"
                >
                  <option value={Enums.RelationshipStatus.Single}>Single</option>
                  <option value={Enums.RelationshipStatus.InRelationship}>In a relationship</option>
                  <option value={Enums.RelationshipStatus.Married}>Married</option>
                  <option value={Enums.RelationshipStatus.Complicated}>It is complicated</option>
                  <option value={Enums.RelationshipStatus.OpenRelationship}>Open relationship</option>
                </select>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <select
                  ...
                  onChange={(e) => updateFormData('reasonForJoining', parseInt(e.target.value))}
                  className="w-full rounded-lg border border-gray-300 py-2 px-3 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-purple-600"
                >
                  <option value={Enums.ReasonForJoining.Dating}>Dating</option>
                  <option value={Enums.ReasonForJoining.Friendship}>Friendship</option>
                  <option value={Enums.ReasonForJoining.Networking}>Networking</option>
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => updateFormData('drinking', parseInt(e.target.value))}
                  className="w-full rounded-lg border border-gray-300 py-2 px-3 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-purple-600"
                >
                  <option value={Enums.Drinking.Never}>Never</option>
                  <option value={Enums.Drinking.Occasionally}>Occasionally</option>
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => updateFormData('smoking', parseInt(e.target.value))}
                  className="w-full rounded-lg border border-gray-300 py-2 px-3 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-purple-600"
                >
                  <option value={Enums.Smoking.Never}>Never</option>
                  <option value={Enums.Smoking.Occasionally}>Occasionally</option>
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1">
                  <span className={formData.description.length > 300 ? 'text-red-500' : ''}>
              ...
              <div className="space-y-2">
                <label className="block text-sm font-medium text-gray-700">Your hobbies (select at least one)</label>
                ...
                {formData.selectedHobbies.length === 0 && 
                  <p className="text-xs text-red-500">Please select at least one hobby</p>
                }
              </div>
            </div>
          </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  onChange={(e) => updateFormData('profilePictureNFT', e.target.value)}
                ...
                <div className="w-48 h-48 rounded-full bg-gray-100 border-2 border-dashed border-gray-300 flex flex-col items-center justify-center">
                  {formData.profilePictureNFT ? (
                    ...
                    <>
                      ...
                      <span className="text-sm text-gray-500">Enter NFT above</span>
                    </>
                  )}
                </div>
              </div>
              ...
              <div className="pt-4">
                <p className="text-sm text-gray-500">
                  Note: You can add additional NFT pictures after registration through the profile update feature.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="mt-8 flex justify-between">
            ...
            <button
              ...
              className={`py-2 px-6 bg-purple-600 text-white rounded-lg hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-600 flex items-center ${
                step === 3 && formData.selectedHobbies.length === 0 ? 'opacity-50 cursor-not-allowed' : ''
              }`}
            >
